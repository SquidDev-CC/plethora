	...
	public IPeripheral getPeripheral(@Nonnull World world, @Nonnull BlockPos blockPos, @Nonnull EnumFacing enumFacing) {
		...
		if (te != null) {
			try {
				...
				IPartialContext<BlockReference> baked = new PartialContext<BlockReference>(reference, new Object[]{new WorldLocation(world, blockPos)}, handler, BasicModuleContainer.EMPTY);
